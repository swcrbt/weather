...
Map<String, dynamic> sampleWeatherJson() => {
  'hourly': {
    'time': ['2026-06-04T12:00', '2026-06-05T12:00', '2026-06-05T13:00'],
    'weathercode': [2, 0, 1],
    'temperature_2m': [18.0, 20.0, 21.0],
    'relativehumidity_2m': [60, 50, 55],
    'apparent_temperature': [17.0, 19.0, 20.0],
    ...
    'winddirection_10m': [170.0, 180.0, 190.0],
    'windgusts_10m': [9.0, 10.0, 11.0],
    'cloudcover': [10.0, 20.0, 30.0],
    'uv_index': [2.0, 3.0, 4.0],
    'dewpoint_2m': [9.0, 10.0, 11.0],
  ...
  'daily': {
    ...
    'apparent_temperature_max': [23.0, 24.0, 25.0],
    'apparent_temperature_min': [13.0, 14.0, 15.0],
    'sunrise': ['06:00', '06:00', '06:01'],
    'sunset': ['18:00', '18:00', '18:01'],
    'precipitation_sum': [0.0, 0.0, 0.0],
    'precipitation_probability_max': [5, 10, 20],
    'windspeed_10m_max': [14.0, 15.0, 16.0],
    'windgusts_10m_max': [24.0, 25.0, 26.0],
    'uv_index_max': [4.0, 5.0, 6.0],
    'rain_sum': [0.0, 0.0, 0.0],
    'winddirection_10m_dominant': [170, 180, 190],
  },
...
MainWeatherCache sampleMainWeatherCache() => MainWeatherCache(
  ...
  precipitationMinutely15: [0.0, 0.0],
  rainMinutely15: [0.0, 0.0],
  showersMinutely15: [0.0, 0.0],
  precipitationProbabilityMinutely15: [0, 0],
  weathercodeDaily: [0, 1],
  temperature2MMax: [25.0, 26.0],
  temperature2MMin: [15.0, 16.0],
  apparentTemperatureMax: [24.0, 25.0],
