...
class TranslationsZhTw extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get hourly_forecast => '逐小時預報';
	@override String get now => '現在';
	@override String get temperature => '溫度';
	@override String get current_temperature => '當前溫度';
	@override String get temperature24h_ago => '24小時前溫度';
	@override String get vs_yesterday => '比昨天';
	@override String get wind_level => '{n}級';
	@override String get rain_starts_in => '{minutes}分鐘後開始下雨';
	@override String get rain_stops_in => '{minutes}分鐘後雨漸停';
	@override String get rain_changes_in => '{minutes}分鐘後{from}轉{to}';
	@override String get rain_starts_now => '即將開始下雨';
	@override String get rain_stops_now => '即將停雨';
	@override String get rain_light => '小雨';
	@override String get rain_moderate => '中雨';
	@override String get rain_heavy => '大雨';
	@override String get rain_torrential => '暴雨';
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'hourly_forecast' => '逐小時預報',
			'now' => '現在',
			'temperature' => '溫度',
			'current_temperature' => '當前溫度',
			'temperature24h_ago' => '24小時前溫度',
			'vs_yesterday' => '比昨天',
			'wind_level' => '{n}級',
			'rain_starts_in' => '{minutes}分鐘後開始下雨',
			'rain_stops_in' => '{minutes}分鐘後雨漸停',
			'rain_changes_in' => '{minutes}分鐘後{from}轉{to}',
			'rain_starts_now' => '即將開始下雨',
			'rain_stops_now' => '即將停雨',
			'rain_light' => '小雨',
			'rain_moderate' => '中雨',
			'rain_heavy' => '大雨',
