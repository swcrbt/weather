...
class TranslationsZhCn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get rain_starts_in => '{minutes}分钟后开始下雨';
	@override String get rain_stops_in => '{minutes}分钟后雨渐停';
	@override String get rain_changes_in => '{minutes}分钟后{from}转{to}';
	@override String get rain_starts_now => '即将开始下雨';
	@override String get rain_stops_now => '即将停雨';
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'vs_yesterday' => '比昨天',
			'wind_level' => '{n}级',
			'rain_starts_in' => '{minutes}分钟后开始下雨',
			'rain_stops_in' => '{minutes}分钟后雨渐停',
			'rain_changes_in' => '{minutes}分钟后{from}转{to}',
			'rain_starts_now' => '即将开始下雨',
			'rain_stops_now' => '即将停雨',
			'rain_light' => '小雨',
			'rain_moderate' => '中雨',
			'rain_heavy' => '大雨',
