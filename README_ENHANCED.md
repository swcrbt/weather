...
<div align='center'>
    <h1>🌦️ Rain Enhanced</h1>
    <p><strong>基于 Rain 和 Overmorrow 融合的天气应用</strong></p>
    <p>支持多数据源（Open-Meteo + 和风天气）、桌面小部件、农历显示</p>
</div>
...
- **降水预警** — 分钟级降水预警通知
- **多语言** — 支持38种语言
- **主题定制** — Material You、AMOLED、自定义颜色
...
- [Rain](https://github.com/darkmoonight/Rain) - 原始项目
- [Overmorrow](https://github.com/bmaroti9/Overmorrow) - 功能参考
